...
RUN ln -snf /usr/share/zoneinfo/$TZ /etc/localtime && \
    ...
    apt-get update && \
    apt-get install -y sudo nano curl software-properties-common build-essential openssh-server unzip apt-transport-https ca-certificates ufw clang zlib1g-dev libkrb5-dev libtinfo5 bash-completion && \
